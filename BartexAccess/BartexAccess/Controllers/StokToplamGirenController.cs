...
{
    public class StokToplamGirenController : Controller
    {
        // GET: StokEnSonGiren
        ...
        public ActionResult Adi(string encodingType, string tarih)
        {
            ...
            var tsql = "SELECT SUM([Depoya Giren Miktar]) as ToplamDepoyaGiren From [dbo_Malzeme Hareketi]   Where Adı =" + "'" + deger + "' AND [Depoya Giren Miktar] > 0 AND [Kayıt Tarihi] <= #" + basTarihCevir + "# Group By Adı";
